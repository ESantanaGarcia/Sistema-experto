...
;;; Regla 3: Alto costo de energía, alta demanda
(defrule alto-costo-alta-demanda
   (dispositivo-energia (id ?id) 
                        (costo-energia alto) 
                        (consumo ?c&:(> ?c 500)))
   =>
   (printout t "Diagnóstico: El dispositivo " ?id " tiene alto costo de energía y alta demanda." crlf
             " -> Recomendación: Priorizar su uso en horarios de bajo costo para reducir gastos." crlf))
